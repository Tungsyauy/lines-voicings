import random
from data import LILYPOND_PITCHES, PITCH_CLASSES_SHARP, PITCH_CLASSES_FLAT, FLAT_KEYS, KEYS
...
def transpose_note(note, semitones, key):
    ...
    if key == "F#" or key == "B" or key == "E" or key == "A" or key == "D" or key == "G":
        if pitch_name in ["Db", "Eb", "Gb", "Ab", "Bb"]:
            pitch_name = {1: "C#", 3: "D#", 6: "F#", 8: "G#", 10: "A#"}[pitch_classes[new_pitch]]
...
def adjust_right_cell(left_cell, right_cell):
    ...
    right_end_pitch, right_end_octave = note_to_pitch(right_cell[-1])
