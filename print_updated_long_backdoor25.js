// Program to show the updated long backdoor 25 phrase construction
// Now uses BACKDOOR_RESOLUTION instead of MAJOR_RESOLUTION_CELLS_down5

console.log("=== UPDATED LONG BACKDOOR 25 PHRASE CONSTRUCTION ===");
console.log("");

// Show the new structure
console.log("OLD STRUCTURE:");
console.log("3 cells from [CELLS2_down2, CELLS_down2, CELLS_down2] + resolution cell from MAJOR_RESOLUTION_CELLS_down5");
console.log("");

console.log("NEW STRUCTURE:");
console.log("3 cells from [CELLS2_down2, CELLS_down2, CELLS_down2] + resolution cell from BACKDOOR_RESOLUTION");
console.log("");
...
console.log("- Required transposition down 5 semitones");
console.log("");
...
console.log("5. Consistent with short backdoor 25 phrases");
console.log("");

console.log("=== EXAMPLE PHRASE STRUCTURE ===");
console.log("For key C backdoor progression (Fm → Bb7 → C):");
console.log("- Position 1: 4 notes from CELLS2_down2 (representing Fm/Bb7)");
console.log("- Position 2: 4 notes from CELLS_down2 (representing Fm/Bb7)");
console.log("- Position 3: 4 notes from CELLS_down2 (representing Fm/Bb7)");
console.log("- Resolution cell: 5 notes from BACKDOOR_RESOLUTION (resolving to C)");
console.log("- Total: 17 notes");
console.log("- Final transposition: +2 semitones (whole step up)");
console.log("");
console.log("Note: The long version still uses the +2 semitone transposition at the end");
console.log("to maintain the same key relationship as before, but now with better");
console.log("resolution patterns from BACKDOOR_RESOLUTION."); 